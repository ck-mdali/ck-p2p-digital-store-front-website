        ...
        <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description_lt" id="description_lt" rows="4" 
                    class="w-full border border-gray-300 rounded px-3 py-2">{{ old('description_lt', $product->description_lt) }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="screenshots" id="screenshots" rows="3" placeholder='e.g. ["url1", "url2"]' 
                    class="w-full border border-gray-300 rounded px-3 py-2">{{ old('screenshots', $product->screenshots) }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="price_inr" id="price_inr" 
                        value="{{ old('price_inr', $product->price_inr) }}" 
                        class="w-full border border-gray-300 rounded px-3 py-2" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="tech_support" id="tech_support" 
                    value="{{ old('tech_support', $product->tech_support) }}" 
            ...
            <div>
                ...
                <input type="text" name="custom_mods" id="custom_mods" 
                    value="{{ old('custom_mods', $product->custom_mods) }}" 
            ...
            <div>
                ...
                <input type="text" name="license" id="license" 
                    value="{{ old('license', $product->license) }}" 
