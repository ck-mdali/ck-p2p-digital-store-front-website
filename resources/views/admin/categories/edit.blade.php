<x-app-layout>
    <div class="max-w-3xl mx-auto px-6 py-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-6">✏️ Edit Category</h1>
        ...
        <form method="POST" action="{{ route('categories.update', $category) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                          class="w-full mt-1 p-2 border border-gray-300 rounded shadow-sm">{{ old('description', $category->description) }}</textarea>
            ...
            <div class="mb-6">
                ...
                @if($category->image)
                    <img src="{{ asset('storage/' . $category->image) }}" alt="Category Image"
                         class="mt-4 w-32 h-32 object-cover rounded shadow">
                @endif
            </div>
